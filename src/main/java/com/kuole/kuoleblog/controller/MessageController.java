...
public class MessageController {
    ...
    //    新增留言
    @PostMapping("/message")
    public String post(Message message, HttpSession session, Model model) throws Exception{
    ...
    public String delete(@PathVariable Long id, RedirectAttributes attributes, Model model) throws Exception{
