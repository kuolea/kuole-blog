...
import com.kuole.kuoleblog.queryvo.SearchBlog;
import com.kuole.kuoleblog.queryvo.ShowBlog;
...
public class BlogController {
    ...
    public String blogs(Model model, @RequestParam(defaultValue = "1",value = "pageNum") Integer pageNum) throws Exception{
        //按照排序字段 倒序 排序
    ...
    public String editPost(@Validated ShowBlog showBlog, RedirectAttributes attributes) throws Exception{
