...
public class TypeController {
    ...
    //  新增分类
    @PostMapping("/types")
    public String post(@Validated Type type, RedirectAttributes attributes) throws Exception{
    ...
    public String editPost(@Validated Type type, RedirectAttributes attributes) throws Exception{
        Type type1 = typeService.getTypeByName(type.getName());
        if (type1 != null) {
            attributes.addFlashAttribute("message", "不能添加重复的分类");
            return "redirect:/admin/types/input";
